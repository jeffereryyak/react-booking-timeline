...
var _reactTooltip = __webpack_require__(153);
...
var DateTimeline = function (_Component) {
  _inherits(DateTimeline, _Component);

  function DateTimeline(props) {
    _classCallCheck(this, DateTimeline);

    var _this = _possibleConstructorReturn(this, (DateTimeline.__proto__ || Object.getPrototypeOf(DateTimeline)).call(this, props));
    // console.time("init");
    ...
    _this.findItem = function (id) {
      ...
      if (id) {
        ...
        item = _this.state.items.find(function (it) {
          return it.id + "" === itemId;
        });
      }
      return item;
    ...
    _this.selectItem = function (id) {
      ...
      if (item) {
        if (item.isFreeEvent) {
          _this.selectFreeItem(id, item);
        } else {
          document.querySelectorAll("[id=" + id + "]").forEach(function (el) {
            el.style.background = item.selectedBgColor || _this.state.defaultSelectedBgColor;
          });
        }
      }
      return item;
    ...
    _this.unselectItem = function (id) {
      var item = _this.findItem(id);
      if (item) {
        if (item.isFreeEvent) {
          // console.log("is FreeEvent");
          _this.unselectFreeItem(id, item);
        } else {
          document.querySelectorAll("[id=" + id + "]").forEach(function (el) {
            el.style.background = item.bgColor || _this.state.defaultBgColor;
          });
        }
      }
    };

    _this.selectFreeItem = function (id, item, isHover) {
      item = item || _this.findItem(id);
      if (item) {
        document.querySelectorAll("[id=" + id + "]").forEach(function (el) {
          el.style.background = isHover ? _this.state.freeEventBgColor : _this.state.freeEventSelectedBgColor;
          el.style.opacity = 1;
        });
      }
      return item;
    ...
    _this.unselectFreeItem = function (id, item) {
      item = item || _this.findItem(id);
      if (item) {
        document.querySelectorAll("[id=" + id + "]").forEach(function (el) {
          el.style.background = _this.state.freeEventBgColor;
    ...
    _this.handleClick = function (e) {
      if (!_this.isMoving) {
        ...
        _this.unselectItem(_this.selectedItemId);
        var item = _this.selectItem(e.target.id);
        _this.selectedItemId = e.target.id;
        if (item && typeof _this.props.onSelect === "function") {
    ...
    _this.onMouseDown = function (evt) {
      if (_this.state.isDesktop) {
        _this.down = true;
        _this.lastPosX = evt.pageX;
        _this.lastPosY = evt.pageY;
      }
    };
    ...
    _this.onMouseMove = function (event) {
      if (_this.down) {
        var diffX = _this.lastPosX - event.pageX;
        var diffY = _this.lastPosY - event.pageY;
        console.log("diff", diffX, diffY);
        if (Math.abs(diffX) > 1 || Math.abs(diffY) > 1) {
          _this.myRef.scrollLeft += diffX;
          _this.myRef.scrollTop += diffY;
          _this.lastPosX = event.pageX;
          _this.lastPosY = event.pageY;
          _this.isMoving = true;
        } else {
          //this.isMoving = false;
        }
    ...
    _this.handleContent = function (id) {
      var item = _this.findItem(id);
      var result = "";
      if (typeof _this.props.contentTooltipRender === 'function') {
        var it = Object.assign({}, item);
        if (it.isFreeEvent) {
          it = {
            group: item.group,
        ...
        result = _this.props.contentTooltipRender(it);
      }
      if (!result && item && item.title) {
        result = _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            null,
            (0, _moment2.default)(item.start).format("LLLL") + " - " + (0, _moment2.default)(item.end).format("LLLL")
          )
        );
      }
      return result;
    ...
    _this.handleMouseMoveFreeEvent = function (event) {
      if (!_this.isMoveOnFreeEvent) {
        _this.isMoveOnFreeEvent = true;
        if (_this.selectedItemId !== event.target.id) {
          // console.log("Event mouse", event.target.id);
          _this.selectFreeItem(event.target.id, undefined, true);
        }
      }
    };

    _this.handleMouseLeaveFreeEvent = function (event) {
      if (_this.isMoveOnFreeEvent) {
        _this.isMoveOnFreeEvent = false;
        if (_this.selectedItemId !== event.target.id) {
          // console.log("Event leave", event.target.id);
          _this.unselectFreeItem(event.target.id);
        }
      }
    };
    ...
    if (config.locale) {
      _moment2.default.locale(config.locale);
    }
    var canSelectedFreeEvent = config && config.canSelectedFreeEvent !== undefined ? config.canSelectedFreeEvent : true;
    startdate = (0, _moment2.default)(startdate);
    enddate = enddate ? (0, _moment2.default)(enddate) : (0, _moment2.default)(startdate).add(6, "months");
    ...
    if (nbDays && items && items.length) {
      ...
      for (var i = 0; i < nbItems; i++) {
        var _items$i = items[i],
            ...
            start = _items$i.start,
            end = _items$i.end,
            bgColor = _items$i.bgColor;

        if (id !== undefined && group !== undefined && start && end && enddate.isAfter(start)) {
          id = id + "";
          group = group + "";
          if (!data[group]) {
            data[group] = {
          ...
          var index = diffDays;
          data[group].days[index] = { id: id, bgColor: bgColor, start: start, end: end, startMiddle: startMiddle };
    ...
    if (groups && groups.length) {
      for (var _i = 0; _i < groups.length; _i++) {
        var _groups$_i = groups[_i],
            _id = _groups$_i.id,
            _title = _groups$_i.title;

        _id = _id + "";
        if (_id && data[_id]) {
          data[_id].title = _title;
        }
      }
    }
    if (canSelectedFreeEvent) {
      for (var _i2 = 0; _i2 < groups.length; _i2++) {
        var groupId = (groups[_i2].id || "") + "";
        var j = 0;
        var dataGroup = data[groupId];
        if (!dataGroup) {
          return _possibleConstructorReturn(_this);
        }
        var infos = void 0;
        var itemId = dataGroup.days[j] && dataGroup.days[j].id;
        var itemChanged = false;
        var isMiddleStart = false;
        var isMiddleEnd = false;
        ...
        while (j < nbDays) {
          if (itemId !== undefined) {
            ...
            infos = {
              ...
              group: groupId,
              style: "s",
              start: (0, _moment2.default)(startdate).add(j, "days").valueOf(),
              bgColor: "grey"
            };
            ...
            if (j > 0 && isMiddleStart) {
              _start -= 1;
              infos.start = (0, _moment2.default)(previousItem.end).valueOf();
            } else {
              infos.start = (0, _moment2.default)(startdate).add(j, "days").set("hour", 8).set("minute", 0).valueOf();
            }
            itemChanged = false;
            ...
            if (j < nbDays - 1 && isMiddleEnd) {
              infos.end = (0, _moment2.default)(previousItem.start).valueOf();
            } else {
              infos.end = (0, _moment2.default)(infos.end).set("hour", 20).set("minute", 0).valueOf();
            ...
            for (var k = _start; k <= j; k++) {
              ...
              if (dataGroup.days[k]) {
                ...
                if (k !== j) {
                  ...
                  dataGroup.days[k].push(_extends({}, infos, {
                    style: k === _start ? "s" + (isMiddleStart ? " startMiddle" : "") : k === j ? "e" + (isMiddleEnd ? " endMiddle" : "") : "b"
                  }));
                } else {
                  // console.log("infos start", infos, moment(infos.start).format('LLL'), moment(infos.end).format('LLL'))
                  dataGroup.days[k].unshift(_extends({}, infos, {
                    style: k === _start ? "s" + (isMiddleStart ? " startMiddle" : "") : k === j ? "e" + (isMiddleEnd ? " endMiddle" : "") : "b"
                  }));
                }
              } else {
                dataGroup.days[k] = _extends({}, infos, {
                  style: k === _start ? "s" + (isMiddleStart ? " startMiddle" : "") : k === j ? "e" + (isMiddleEnd ? " endMiddle" : "") : "b"
                });
              }
            }
    ...
    _this.state = {
      ...
      freeEventBgColor: config && config.freeEventBgColor || "#d2cdcd",
      freeEventSelectedBgColor: config && config.freeEventSelectedBgColor || "#d2cdcd",
      ...
      showGroups: config && config.showGroups !== undefined ? config.showGroups : true,
      showTooltip: config && config.showTooltip !== undefined ? config.showTooltip : true,
      canSelectedFreeEvent: canSelectedFreeEvent,
      defaultSelectedBgColor: config && config.selectedBgColor || "#a074c4",
      tooltipClassName: config && config.tooltipClassName,
      isDesktop: (0, _utils.getDeviceType)() === "Desktop"
    };
    return _this;
  }

  _createClass(DateTimeline, [{
    key: "render",
    value: function render() {
      ...
      var _state = this.state,
          ...
          nbDays = _state.nbDays,
          data = _state.data,
          showGroups = _state.showGroups,
          groupLabel = _state.groupLabel,
          headerBgColor = _state.headerBgColor,
          headerColor = _state.headerColor,
          showTooltip = _state.showTooltip,
          tooltipClassName = _state.tooltipClassName;
      // console.log("showGroups", showGroups);

      var months = [];
      var days = [];
      var d = (0, _moment2.default)(startdate);
      var numMonth = d.month();
      var daysInMonth = d.daysInMonth() - parseInt(d.format("DD"), 10) + 1;
      var monthName = d.format("MMMM YYYY");
      ...
      for (var i = 0; i < nbDays; i++) {
        days.push(_react2.default.createElement(
          "th",
          { key: "thd-" + days.length, className: "subheader" },
          d.format("DD")
        ));
        // let theDay = moment(d).add(i, 'days')

        var _loop = function _loop(j) {
          var slots = data[keys[j]].days[i];

          var infos = [];
          var classMultiEvent = "multiEvents";
          var clazzTd = "noPadding ";
          if (d.day() === 6 || d.day() === 0) {
          ...
          if (slots) {
            ...
            slots.forEach(function (slot) {
              if (slot) {
                ...
                if (slot.isFreeEvent) {
                  addHandles.onMouseMove = _this2.handleMouseMoveFreeEvent;
                  addHandles.onMouseLeave = _this2.handleMouseLeaveFreeEvent;
                }
                ...
                // console.log("=>", slot);
                var className = "slot" + slot.id + " " + slot.style + " pointer red tp ";
                ...
                var defaultBg = slot.bgColor || _this2.state.defaultBgColor;
                var background = slot.isFreeEvent ? slot.selectItem ? _this2.state.freeEventSelectedBgColor : _this2.state.freeEventBgColor || defaultBg : defaultBg;
                // console.log("className", className);
                infos.push(_react2.default.createElement("div", _extends({
          ...
          datas[keys[j]] = datas[keys[j]] || (showGroups ? [_react2.default.createElement(
            "td",
            { key: "tdd00", className: "fixCol" },
            data[keys[j]].title
          )] : []);

          datas[keys[j]].push(_react2.default.createElement(
            "td",
            {
      ...
      console.log("==>", nbDays, (0, _moment2.default)(enddate).month(), numMonth);
      if ((0, _moment2.default)(enddate).month() === numMonth) {
        months.push(_react2.default.createElement(
          "th",
          {
            key: "th-" + months.length,
      ...
      var thGroups = null;
      if (showGroups) {
        thGroups = _react2.default.createElement(
          "th",
          {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "tbody",
            { id: "tbody", onMouseLeave: this.onMouseUp },
...
var _BookingTimeline = __webpack_require__(134);

var _BookingTimeline2 = _interopRequireDefault(_BookingTimeline);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

module.exports = _BookingTimeline2.default;
...
var getDeviceType = function getDeviceType() {
  ...
  var Return_Device;
  if (/(up.browser|up.link|mmp|symbian|smartphone|midp|wap|phone|android|iemobile|w3c|acs\-|alav|alca|amoi|audi|avan|benq|bird|blac|blaz|brew|cell|cldc|cmd\-|dang|doco|eric|hipt|inno|ipaq|java|jigs|kddi|keji|leno|lg\-c|lg\-d|lg\-g|lge\-|maui|maxo|midp|mits|mmef|mobi|mot\-|moto|mwbp|nec\-|newt|noki|palm|pana|pant|phil|play|port|prox|qwap|sage|sams|sany|sch\-|sec\-|send|seri|sgh\-|shar|sie\-|siem|smal|smar|sony|sph\-|symb|t\-mo|teli|tim\-|tosh|tsm\-|upg1|upsi|vk\-v|voda|wap\-|wapa|wapi|wapp|wapr|webc|winw|winw|xda|xda\-) /i.test(info)) {
    if (/(tablet|ipad|playbook)|(android(?!.*(mobi|opera mini)))/i.test(info)) {
      Return_Device = "Tablet";
    } else {
      Return_Device = "Mobile";
    }
  } else if (/(tablet|ipad|playbook)|(android(?!.*(mobi|opera mini)))/i.test(info)) {
    Return_Device = "Tablet";
  } else {
...
// Module
exports.push([module.i, ".table-scroll {\n  position: relative;\n  width: 100%;\n  z-index: 1;\n  margin: auto;\n  overflow: auto;\n  height: 100%;\n  -webkit-overflow-scrolling: touch;\n  /*\n  thead.jeff2 {\n    background: white;\n    position: sticky;\n    left: 0;\n    z-index:20;\n    box-shadow: 0 2px 2px -1px rgba(0, 0, 0, 0.4);\n  }\n  */ }\n  .table-scroll table {\n    width: 100%;\n    min-width: 100%;\n    margin: auto;\n    border-collapse: separate;\n    border-spacing: 0;\n    text-align: left;\n    /* position: relative; \n    border-collapse: collapse; */\n    -webkit-touch-callout: none;\n    -webkit-user-select: none;\n    -khtml-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none; }\n  .table-scroll tbody {\n    -webkit-overflow-scrolling: touch; }\n  .table-scroll th,\n  .table-scroll td {\n    /* padding: 0.25rem; */ }\n  .table-scroll tbody td:not(:first-child) {\n    width: 25px;\n    max-width: 25px;\n    min-width: 25px;\n    white-space: nowrap;\n    /* overflow: hidden; */\n    text-overflow: ellipsis; }\n  .table-scroll thead th:not(:first-child) {\n    text-align: center;\n    border-left: 1px solid lightgrey; }\n  .table-scroll tr.red th {\n    background: red;\n    color: white; }\n  .table-scroll tr.green th {\n    background: green;\n    color: white; }\n  .table-scroll tr.purple th {\n    background: purple;\n    color: white; }\n  .table-scroll th {\n    min-height: 33px;\n    height: 21px; }\n  .table-scroll td {\n    border-left: 1px solid lightgrey;\n    border-bottom: 1px solid lightgrey; }\n  .table-scroll .noBorderLeft {\n    border-left: none !important; }\n  .table-scroll .noPadding {\n    padding: 0; }\n  .table-scroll th.header {\n    /*\n    background: #519aba;\n    color: white;\n    */\n    position: sticky;\n    position: -webkit-sticky;\n    top: 0;\n    z-index: 10;\n    box-shadow: 0 2px 2px -1px rgba(0, 0, 0, 0.4); }\n  .table-scroll tr:nth-child(even) {\n    background: #f9f9f9; }\n  .table-scroll tr:nth-child(odd) {\n    background: #fff; }\n  .table-scroll th.subheader {\n    background: #f1eded;\n    position: sticky;\n    position: -webkit-sticky;\n    top: 20px;\n    z-index: 10;\n    box-shadow: 0 2px 2px -1px rgba(0, 0, 0, 0.4); }\n  .table-scroll .stickyH {\n    position: sticky !important;\n    position: -webkit-sticky !important;\n    left: 50%;\n    float: left;\n    padding-left: 1rem; }\n  .table-scroll .c {\n    /* position: relative !important;**/\n    left: 0px !important; }\n  .table-scroll .d {\n    position: relative !important;\n    left: 20px; }\n  .table-scroll .item-weekend {\n    background: #f1f1f1; }\n  .table-scroll .table-wrap {\n    position: relative; }\n  .table-scroll .fixHeadCol {\n    position: sticky;\n    position: -webkit-sticky;\n    left: 0px;\n    z-index: 11 !important;\n    max-width: 150px;\n    box-shadow: 0 2px 2px -1px rgba(0, 0, 0, 0.4); }\n  .table-scroll .fixCol {\n    background: #f7f7f7;\n    position: sticky;\n    position: -webkit-sticky;\n    left: 0px;\n    z-index: 13;\n    min-width: max-content;\n    max-width: 200px;\n    width: max-content;\n    box-shadow: 0 2px 2px -1px rgba(0, 0, 0, 0.4); }\n  .table-scroll .content {\n    text-align: center;\n    white-space: nowrap;\n    overflow: hidden;\n    text-overflow: ellipsis; }\n  .table-scroll .centerText {\n    text-align: center; }\n  .table-scroll .s {\n    border-top-left-radius: 5px;\n    border-bottom-left-radius: 5px;\n    border-left: none;\n    border-right: none;\n    margin-top: 2px;\n    margin-bottom: 2px;\n    margin-left: 2px;\n    display: block;\n    height: 16px;\n    width: 100%; }\n  .table-scroll .sSelected {\n    border: 1px solid black;\n    border-right: none; }\n  .table-scroll .b {\n    border-left: none;\n    border-right: none;\n    margin-top: 2px;\n    margin-bottom: 2px;\n    display: block;\n    height: 16px;\n    margin-left: -2px;\n    width: 100%; }\n  .table-scroll .bSelected {\n    border: 1px solid black;\n    border-right: none;\n    border-left: none;\n    width: 100%; }\n  .table-scroll .e {\n    border-top-right-radius: 5px;\n    border-bottom-right-radius: 5px;\n    border-left: none;\n    border-right: none;\n    margin-top: 2px;\n    margin-bottom: 2px;\n    margin-right: 2px;\n    display: block;\n    height: 16px;\n    margin-left: -2px;\n    width: 100%; }\n  .table-scroll .eSelected {\n    border: 1px solid black;\n    border-left: none; }\n  .table-scroll .bgSelected {\n    background: orange !important; }\n  .table-scroll .pointer {\n    cursor: pointer; }\n  .table-scroll .red {\n    background: red;\n    /* border: none !important; */ }\n  .table-scroll .noVBorder {\n    border-left: none;\n    border-right: none;\n    padding: 0; }\n  .table-scroll .endMiddle {\n    width: 50%;\n    float: left; }\n  .table-scroll .startMiddle {\n    width: 50%;\n    float: right; }\n  .table-scroll .multiEvents {\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    margin-left: -2px; }\n  .table-scroll .multiEvents-Invert {\n    display: flex;\n    flex-direction: row-reverse;\n    align-items: center;\n    margin-left: -2px; }\n", ""]);
...
var _constant = __webpack_require__(133);
...
var _staticMethods = __webpack_require__(150);

var _staticMethods2 = _interopRequireDefault(_staticMethods);

var _windowListener = __webpack_require__(152);

var _windowListener2 = _interopRequireDefault(_windowListener);

var _customEvent = __webpack_require__(147);

var _customEvent2 = _interopRequireDefault(_customEvent);

var _isCapture = __webpack_require__(149);

var _isCapture2 = _interopRequireDefault(_isCapture);

var _getEffect = __webpack_require__(148);

var _getEffect2 = _interopRequireDefault(_getEffect);

var _trackRemoval = __webpack_require__(151);

var _trackRemoval2 = _interopRequireDefault(_trackRemoval);

var _getPosition = __webpack_require__(156);

var _getPosition2 = _interopRequireDefault(_getPosition);

var _getTipContent = __webpack_require__(157);

var _getTipContent2 = _interopRequireDefault(_getTipContent);

var _aria = __webpack_require__(155);

var _nodeListToArray = __webpack_require__(158);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/dist/cjs.js!../node_modules/sass-loader/lib/loader.js!./BookingTimeline.scss", function() {
			var newContent = require("!!../node_modules/css-loader/dist/cjs.js!../node_modules/sass-loader/lib/loader.js!./BookingTimeline.scss");

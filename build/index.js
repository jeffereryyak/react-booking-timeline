...
var DateTimeline = function (_Component) {
  ...
  function DateTimeline(props) {
    ...
    var canSelectedFreeEvent = props.config && props.config.canSelectedFreeEvent !== undefined ? props.config.canSelectedFreeEvent : true;
    startdate = (0, _moment2.default)(startdate);
    enddate = (0, _moment2.default)(enddate || startdate).add(6, "months");
    ...
    if (nbDays && items && items.length) {
      ...
      for (var i = 0; i < nbItems; i++) {
        ...
        if (id !== undefined && group !== undefined && start && end &&
    ...
    _this.state = {
      ...
      freeEventBgColor: props.config && props.config.freeEventBgColor || "#d2cdcd",
      freeEventSelectedBgColor: props.config && props.config.freeEventSelectedBgColor || "#d2cdcd",
      ...
      showGroups: props.config && props.config.showGroups !== undefined ? props.config.showGroups : true,
      showTooltip: props.config && props.config.showTooltip !== undefined ? props.config.showTooltip : true,
      canSelectedFreeEvent: canSelectedFreeEvent,
      defaultSelectedBgColor: props.config && props.config.selectedBgColor || "#a074c4",
